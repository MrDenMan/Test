class StudentsController < ApplicationController
  ...
  def students_without_parents
    render json: Student.where.not(parent_id: Parent.all.ids).count
  end
  ...
  private
    ...
    def student_params
      params.require(:student).permit(:name, :parent_id)
    end
end
